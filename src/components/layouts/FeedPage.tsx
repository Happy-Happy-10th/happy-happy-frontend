  ...
  return(
    <div className={cn("h-full w-hull flex xl:flex-row flex-col gap-5 p-7.5 bg-yoteyo-gray-100")}>
      ...
      <div className="flex flex-col gap-5">
        <div className="xl:w-123 w-full xl:h-17 bg-yoteyo-main rounded-t-[8px] rounded-r-[8px] flex items-center justify-center">
          <Text className="text-white" variant={"body1"}>요때요 맞춤 오늘의 특별한 일정을 지금 바로 확인해보세요!</Text>
        </div>

        <div className="xl:w-177 w-full p-6 min-h-100 bg-white rounded-[8px] flex-1 flex flex-col justify-between">
          <div>
