...
const eventChildVariants = cva(`pl-[5px] w-[2px] h-[16.5px] rounded-[4px]`, {
  variants: {
    variant: {
      yoteyoRed: 'bg-yoteyo-red',
      yoteyoOrange: 'bg-yoteyo-orange',
...
export default function CalendarEvent({ title, allDay, start, end, repeat, color, locate, memo }: CalendarEventType) {
  return (
